...
export function CinematicHero({ 
  ...
  // Backdoor Admin Authentication
  const [showBackdoorModal, setShowBackdoorModal] = useState(false);
  const [backdoorId, setBackdoorId] = useState("");
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2
                onDoubleClick={() => setShowBackdoorModal(true)}
                className="text-6xl md:text-[6rem] lg:text-[8rem] font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0 cursor-pointer select-none"
              >
                {brandName}
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        ...
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-neutral-800 shadow-lg shadow-black/50">JS</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/5 flex items-center justify-center mr-3 border border-blue-800 shadow-inner">
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/5 flex items-center justify-center mr-3 border border-emerald-800 shadow-inner">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-blue-500/20 to-blue-900/10 flex items-center justify-center border border-blue-800 shadow-inner">
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-800 shadow-inner">
      ...
      {/* Hidden Backdoor Admin Login Modal */}
      {showBackdoorModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-md p-4">
          <div className="w-full max-w-sm rounded-3xl border border-neutral-800 bg-[#0c1220]/90 p-6 shadow-2xl relative animate-fadeIn">
            <button 
              onClick={() => {
            ...
            <div className="text-center mb-6">
              <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-blue-500/10 border border-blue-800 text-blue-400">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <h4 className="text-md font-bold text-white">Security Verification</h4>
              <p className="text-xs text-neutral-400 mt-1">Enter credentials to unlock console</p>
            </div>

            {backdoorError && (
              <div className="mb-4 rounded-xl border border-red-900 bg-red-500/5 p-3 text-center text-xs text-red-400">
                {backdoorError}
              </div>
            )}
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-neutral-800 bg-white/5 py-2.5 px-3 text-xs text-white placeholder-neutral-500 outline-none focus:border-blue-500/50 focus:bg-white/10 transition"
                />
              </div>
            ...
            <button
              onClick={async () => {
                if (backdoorId === "21122006" && backdoorPassword === "2112") {
                  setBackdoorError("");
                  try {
                    // Sign in admin@tipstar.com in the background so that RLS policies work!
                    let { data, error } = await supabase.auth.signInWithPassword({
                      email: "admin@tipstar.com",
                      password: "adminpassword"
                    });
                    
                    if (error) {
                      // Attempt auto-signup on fail
                    ...
                    setBackdoorError("Error setting up backdoor session: " + err.message);
                  }
                } else {
                  setBackdoorError("Invalid Admin ID or Security Password");
                }
              }}
              className="w-full rounded-xl bg-blue-600 py-2.5 text-xs font-semibold text-white shadow-lg hover:bg-blue-500 transition active:scale-[0.98]"
            >
              Verify & Proceed
            </button>
          </div>
...
// Inline CSS Keyframes for Backdoor Animations
